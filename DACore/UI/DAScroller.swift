...
class DAScroller
{
    ...
    func beginDrag(_ touch_position:CGFloat)
    {
        if(_isDragging)
        {
            return
    ...
    func endDrag(_ touch_position:CGFloat)
    {
        if(!_isDragging)
        {
            return
    ...
    func updateDrag(_ touch_position:CGFloat)
    {
    ...
    func setPosition(_ position:CGFloat, andSpeed:CGFloat)
    {
        _position = position
        _speed = speed
    }
